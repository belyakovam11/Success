...
VALUES
    ...
    ('Когда была подписана Декларация независимости США?', '1776,1789,1799,1804', '1776', 10, 'История', NOW()),
    ('Какая страна была центром Римской империи?', 'Греция,Турция,Италия,Франция', 'Италия', 10, 'История', NOW()),
    ('Кто был последним фараоном Древнего Египта?', 'Рамсес II,Клеопатра,Тутанхамон,Ахмес I', 'Клеопатра', 10, 'История', NOW());
